package com.example.hf.myweather;
...
private Activity context;
    ...
    private static String key="&key=1dcd2f8e59e057a2260bba2d23dce5c5";
    ...
    protected void onPostExecute(List<Map<String, Object>> result) {
        ...
        if (result.size()>0){
            ...
            SimpleAdapter simpleAdapter=new SimpleAdapter(context,result,R.layout.weather_item,new String[]{"temperature","weather","date","week","weather_icon"},new int[]{R.id.temperature,R.id.weather,R.id.date,R.id.week,R.id.weather_icon});
